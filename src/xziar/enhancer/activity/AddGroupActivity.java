...
public class AddGroupActivity extends AppCompatActivity implements OnItemClickListener<TaskBean>
{
	...
	private NetBeansTask<JSONObject> searchTask = new NetBeansTask<JSONObject>("/mytask", "tasks",
			JSONObject.class)
	{
		@Override
