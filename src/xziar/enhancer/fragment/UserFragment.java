...
public class UserFragment extends Fragment implements OnClickListener
{
	...
	public void onClick(View v)
	{
		...
		{
			AlertDialog dlg = new AlertDialog.Builder(getActivity()).setTitle("ÐÞ¸Ä")
					.setView(R.layout.dialog_chgpwd).setPositiveButton("ÐÞ¸Ä", null)
					.setNegativeButton("·ÅÆú", null).create();
			dlg.show();
		}
	}
}
